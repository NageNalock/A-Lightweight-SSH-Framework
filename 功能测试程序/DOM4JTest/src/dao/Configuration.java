...
public class Configuration {
    ...
    ArrayList<OrClassConfiguration> classList = new ArrayList<>();
    ...
    {
        try {
            InputStream inputStream = this.getClass().getResourceAsStream("/dao/or_mapping.xml");
        ...
        for(Element classFeatureElement:classFeaturesList)
        {
            switch (classFeatureElement.getName())
            {
                ...
                case "id":
                {
                    ...
                    orClassConfigurationTemp.setId(textTrim);
                    break;
                }
                case "property":
                {
